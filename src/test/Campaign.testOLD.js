...
//
//     bank = await new web3.eth.Contract(bankCompiled.Bank.abi)
//         .deploy({
//             data: bankCompiled.Bank.evm.bytecode.object,
//             arguments: [fabricAddress]
//         })
//         .send({from: accounts[0], gas: '3000000'});
//
//     fns = await new web3.eth.Contract(fnsCompiled.Fns.abi)
//         .deploy({data: fnsCompiled.Fns.evm.bytecode.object})
//         .send({from: accounts[0], gas: '3000000'});
//
//     ofd = await new web3.eth.Contract(ofdCompiled.Ofd.abi)
//         .deploy({data: ofdCompiled.Ofd.evm.bytecode.object})
//         .send({from: accounts[0], gas: '3000000'});
//
//     shop = await new web3.eth.Contract(shopCompiled.Shop.abi)
//         .deploy({
//             data: shopCompiled.Shop.evm.bytecode.object,
//             arguments: [addressOfd]
//         })
//         .send({from: accounts[0], gas: '3000000'});
//
//     await ofd.methods
